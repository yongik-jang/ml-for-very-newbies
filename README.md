...
Slides and hands-on notebooks for an introduction to machine learning,
...
Open in Colab. Use a GPU runtime for `02_mnist`.
...
`01` reproduces claims from the slides in small, checkable pieces (a perceptron by hand,
